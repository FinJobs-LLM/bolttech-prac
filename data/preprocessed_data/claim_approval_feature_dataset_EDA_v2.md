...
- **File path:** `data/preprocessed_data/claim_approval_feature_dataset_v2.xlsx`
- **Number of rows:** 2880
...
| `turnOnOff` | Categorical | object | ✅ Yes |
| `touchScreen` | Categorical | object | ✅ Yes |
| `smashed` | Categorical | object | ✅ Yes |
| `frontCamera` | Categorical | object | ✅ Yes |
| `backCamera` | Categorical | object | ✅ Yes |
| `frontOrBackCamera` | Categorical | object | ✅ Yes |
| `audio` | Categorical | object | ✅ Yes |
| `mic` | Categorical | object | ✅ Yes |
| `buttons` | Categorical | object | ✅ Yes |
...
| `retailerName` | Categorical | 0 | 0.00% |
| `deviceType` | Categorical | 0 | 0.00% |
| `channel` | Categorical | 0 | 0.00% |
| `claimType` | Categorical | 0 | 0.00% |
| `country` | Categorical | 0 | 0.00% |
| `turnOnOff` | Categorical | 0 | 0.00% |
| `touchScreen` | Categorical | 0 | 0.00% |
| `smashed` | Categorical | 0 | 0.00% |
| `frontCamera` | Categorical | 0 | 0.00% |
| `backCamera` | Categorical | 0 | 0.00% |
| `frontOrBackCamera` | Categorical | 0 | 0.00% |
| `audio` | Categorical | 0 | 0.00% |
| `mic` | Categorical | 0 | 0.00% |
| `buttons` | Categorical | 0 | 0.00% |
...
- **Missing values:** 0 (0.00%)
- **Unique values:** 10
- **List of unique values:** `WUAWEI eStore`, `SWEDEN ESTORE BULK UPLOAD`, `WUAWEI SCPUserPortal`, `Unknown`, `PSFM RETAIL ELECTRONICS`, `EVOLLIS`, `bolttech D2C`, `BREDA SES`, `UTRECHT SES`, `FINLAND ESTORE BULK UPLOAD`
...
- **Missing values:** 0 (0.00%)
- **Unique values:** 3
- **List of unique values:** `Unknown`, `1`, `0`
...
- **Missing values:** 0 (0.00%)
- **Unique values:** 2
- **List of unique values:** `Unknown`, `0`
...
- **Missing values:** 0 (0.00%)
- **Unique values:** 3
- **List of unique values:** `Unknown`, `0`, `1`
...
- **Numeric-stored categorical features:** `has_prior_rrp_usage`. Stored as numbers but represent categories/flags; cast to category before modeling so they are not treated as continuous.
