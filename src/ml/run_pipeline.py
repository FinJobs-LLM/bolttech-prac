...
from config import (
    ...
    N_TRIALS, NEGATIVE_LABEL, POSITIVE_LABEL, ROOT, THRESHOLD_CSV, ensure_dirs,
)
...
from ml.model_factory import IMBALANCE_LABEL, fit_model
...
def main():
    ...
    # ROOT (from config) is the repo root, independent of this file's location.
    fe_public = ROOT / "model-dashboard" / "public"
    if fe_public.exists():
